from calamari.proto import TextProcessorParams

from calamari.ocr.text_processing.text_processor import MultiTextProcessor, TextProcessor, NoopTextProcessor
from calamari.ocr.text_processing.basic_text_processors import StripTextProcessor, BidiTextProcessor
from calamari.ocr.text_processing.default_text_preprocessor import DefaultTextPreprocessor
from calamari.ocr.text_processing.default_text_postprocessor import DefaultTextPostprocessor
from calamari.ocr.text_processing.text_synchronizer import synchronize
