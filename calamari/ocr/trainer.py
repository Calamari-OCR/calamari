from calamari.ocr.text_processing import text_processor_from_proto
from calamari.ocr.data_processing import data_processor_from_proto
from calamari.ocr import Codec
from calamari.ocr.backends import create_backend_from_proto
import time
import os

from calamari.utils import RunningStatistics
